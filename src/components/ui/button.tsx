  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-2xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-300 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        gold:
          "border-gold bg-gold text-white shadow-sm hover:bg-gold/90 hover:text-white hover:shadow-md focus-visible:ring-gold/40 [a]:hover:bg-gold/90 [a]:hover:text-white",
        success:
          "border-success bg-success text-white shadow-sm hover:bg-success/90 hover:text-white hover:shadow-md focus-visible:ring-success/40 [a]:hover:bg-success/90 [a]:hover:text-white",
      },
      size: {
        default:
