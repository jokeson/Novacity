...
export const DashboardPageView = ({
  ...
  return (
    <Container className="space-y-8 pb-12 pt-4 md:space-y-10 md:pb-14 md:pt-6">
      <section className="flex flex-col gap-3 sm:gap-4 md:flex-row md:items-end md:justify-between md:gap-8">
        <div className="min-w-0 space-y-1.5 sm:space-y-2">
          <h2 className="font-heading text-foreground text-2xl font-semibold tracking-tight sm:text-3xl">
            Overview
          </h2>
        ...
        <p className="text-foreground font-heading min-w-0 text-lg font-semibold tracking-tight sm:text-xl md:shrink-0 md:text-right md:text-2xl">
